...
describe('AI discovery subject-grade search coverage', () => {
  ...
  it('reflects Wave05/06 depth additions without freezing fragile per-grade totals', () => {
    expect(aiDiscoveryCoverageFor('chinese', 1)?.candidateCount).toBeGreaterThanOrEqual(12)
    expect(aiDiscoveryCoverageFor('chinese', 2)?.candidateCount).toBeGreaterThanOrEqual(11)
    expect(aiDiscoveryCoverageFor('chinese', 6)?.candidateCount).toBeGreaterThanOrEqual(12)
    expect(aiDiscoveryCoverageFor('english', 3)?.candidateCount).toBeGreaterThanOrEqual(9)
    expect(aiDiscoveryCoverageFor('english', 4)?.candidateCount).toBeGreaterThanOrEqual(7)
    expect(aiDiscoveryCoverageFor('english', 5)?.candidateCount).toBeGreaterThanOrEqual(9)
    expect(aiDiscoveryCoverageFor('english', 6)?.candidateCount).toBeGreaterThanOrEqual(9)
    expect(aiDiscoveryCoverageFor('math', 1)?.candidateCount).toBeGreaterThanOrEqual(7)
    expect(aiDiscoveryCoverageFor('math', 4)?.candidateCount).toBeGreaterThanOrEqual(5)
    expect(aiDiscoveryCoverageFor('math', 6)?.candidateCount).toBeGreaterThanOrEqual(5)
  })
})
